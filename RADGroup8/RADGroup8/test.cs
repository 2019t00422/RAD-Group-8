...
namespace Scientific_Calculator
{
    public partial class MainForm : Form
    {
        ...
        {
            //Update expression in textBox1 as well as evaluationString
            evaluationString += ex;
            textBox1.Text += ex;
        }
        ...
        private void SwapValues()
        {
            ...
            textBox1.Text = txtBoxResult.Text;
            txtBoxResult.Text = "";
        ...
        private void BackSpaceClick()
        {
            if (textBox1.Text.Length > 0)
            {
                ...
                string tempExpression = textBox1.Text;
                ...
                textBox1.Text = tempExpression.Remove(tempExpression.Length - 1);
                //Set updated value in evaluationString as well
                evaluationString = textBox1.Text;
                //Clear ResultTextBox
                txtBoxResult.Text = "";
            }
            textBox1.Select(textBox1.Text.Length, 0);
        ...
        //Evaluate textBox1 each time when text on it changes
        ...
        private void btnBrackets_Click(object sender, EventArgs e)
        {
            ...
            if (countOfBracket == 0 && textBox1.Text.Length == 0)
            {
                UpdateExpression("(");
                countOfBracket++;
            }
            ...
            else if (textBox1.Text.LastIndexOf('(') == textBox1.Text.Length - 1)
            {
                UpdateExpression("(");
                countOfBracket++;
            }
            ...
            //
            else if (countOfBracket == 0 && numericEnd.IsMatch(textBox1.Text))
            {
                UpdateExpression("*(");
                countOfBracket++;
                ...
                case 241:
                    {
                        ...
                        while (index >= 0 && (evaluationString[index] != '+' && textBox1.Text[index] != '-' && textBox1.Text[index] != '*' && textBox1.Text[index] != '/' && textBox1.Text[index] != '%' && textBox1.Text[index] != '(' && textBox1.Text[index] != ')'))
                        {
        ...
        private void ParseFunctionText(string Text, string name)
        {
            ...
            if (textBox1.Text.Length == 0 || regex.IsMatch(textBox1.Text))
            {
                //Updating Expression
        ...
        private void ParsePowerFunctionText(string command, string Name)
        {
            ...
            //Check Whether textBox1 is empty or not and it doesn't ends with /,*,-,+,%,(,)
            if (!(expression.Length == 0 || regex.IsMatch(textBox1.Text)))
            {
                if (command == "x^2")
                {
                    UpdateExpression("^(2)");
        ...
        //Validate key press on textBox1
